...
sed -i "/uci commit network/i\uci set network.lan.broadcast='192.168.123.200'" $ZZZ         # IPv4 广播
...
sed -i "s/OpenWrt /huihui build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" $ZZZ        # 增加自己个性名称281677160
